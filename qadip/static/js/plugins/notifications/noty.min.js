 ...
 */
    ...
    $.noty.defaults = {
        ...
        text        : '',
        dismissQueue: true,
        template    : '<div class="noty_message"><span class="noty_text"></span><button type="button" class="btn noty_close"><i class="fa fa-close"></i></button></div>',
        animation   : {
            open  : {height: 'toggle'},
            close : {height: 'toggle'},
            easing: 'swing',
...
$.noty.themes.defaultTheme = {
    ...
    style   : function() {
        ...
        this.$bar.on({
            mouseenter: function() {
                $(this).find('.noty_close').stop().fadeTo(50, 1);
            },
            mouseleave: function() {
                $(this).find('.noty_close').stop().fadeTo(50, 0);
            }
        });
