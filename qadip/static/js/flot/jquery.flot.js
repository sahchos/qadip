    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < entries.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style="border:1px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="width:100%;height:0;border:5px solid ' + entry.color + ';overflow:hidden"></div></div></td>' +
            ...
            var table = '<table style="font-size:smaller;color:' + options.grid.color + ';width:auto;">' + fragments.join("") + '</table>';
            if (options.legend.container != null)
                ...
                if (options.legend.backgroundOpacity != 0.0) {
                    ...
                    $('<div style="position:absolute;height:' + div.height() + 'px;' + pos +'background-color:' + c + ';"> </div>').prependTo(legend).css('opacity', options.legend.backgroundOpacity);
                }
            }
        }
